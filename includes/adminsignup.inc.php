...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $aid = htmlspecialchars($_POST['aid'], ENT_QUOTES, 'UTF-8');
    ...
    $signup = new AdminSingupContr($aid, $uid, $pwd, $pwdrepeat, $email);
    ...
    header("location: ../views/adminlogin.view.php?error=none");
}